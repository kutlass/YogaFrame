    ...
    public class Deployment
    {
        ...
        public static bool ExecuteNonQuery()
        {
            ...
            string[] rg_strMySqlCommands = new string[]
            {
                ...
                HelperMySql.GenerateQueryString(@".\Scripts.MySQL\function_MemberIsEmailVerifiedYet_drop.txt"),
                HelperMySql.GenerateQueryString(@".\Scripts.MySQL\function_MemberIsEmailVerifiedYet_create.txt"),
                HelperMySql.GenerateQueryString(@".\Scripts.MySQL\function_MemberValidateActivationGuid_drop.txt"),
                HelperMySql.GenerateQueryString(@".\Scripts.MySQL\function_MemberValidateActivationGuid_create.txt"),
